...
def test_urls_work_at_root_and_github_pages_base() -> None:
    ...
    assert category_url("birds") == "/observe/curiosities/"
    assert bird_species_url("California Scrub-Jay") == "/observe/curiosities/birds/california-scrub-jay/"
    assert craft_url("Hand Embroidery", "/field-notes") == "/field-notes/crafts/hand-embroidery/"
    assert posts_url("/field-notes") == "/field-notes/posts/"
